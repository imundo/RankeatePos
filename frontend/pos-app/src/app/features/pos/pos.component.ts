        ...
        <aside class="menu-sidebar">
          ...
          <nav class="menu-nav">
            ...
            <div class="menu-section">
              ...
              <button *ngIf="canAccess('products')" class="menu-item" routerLink="/catalog" (click)="showMenu = false">
                <div class="item-icon purple">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="menu-section">
              ...
              <button *ngIf="canAccess('billing')" class="menu-item" routerLink="/facturacion" (click)="showMenu = false">
              ...
              <button *ngIf="canAccess('purchases')" class="menu-item" routerLink="/compras" (click)="showMenu = false">
                ...
                <span class="item-text">Órdenes Compra</span>
              </button>
            ...
            <div class="menu-section">
              ...
              <button *ngIf="canAccess('dashboard')" class="menu-item" routerLink="/dashboard" (click)="showMenu = false">
                <div class="item-icon purple">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="menu-section">
              ...
              <button *ngIf="canAccess('hr')" class="menu-item" routerLink="/rrhh/leaves" (click)="showMenu = false">
                ...
                <span class="item-text">Vacaciones y Permisos</span>
              </button>
            </div>
            ...
            <div class="menu-section">
              ...
              <button *ngIf="canAccess('company')" class="menu-item" routerLink="/company" (click)="showMenu = false">
                <div class="item-icon indigo">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <button *ngIf="canAccess('users')" class="menu-item" routerLink="/settings/users" (click)="showMenu = false">
                <div class="item-icon teal">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/>
                  </svg>
...
export class PosComponent implements OnInit {
  ...
  async imprimirDocumento(): Promise<void> {
    ...
    if (!receiptElement) {
      this.messageService.add({ severity: 'error', summary: 'Error', detail: 'No se encontró el recibo para imprimir' });
      return;
    }
  ...
  enviarPorEmail() {
    this.messageService.add({ severity: 'info', summary: 'Enviado', detail: 'Comprobante enviado al cliente' });
  }
