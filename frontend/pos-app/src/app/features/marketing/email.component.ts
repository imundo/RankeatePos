    ...
    <div class="page-container">
      <header class="page-header">
        ...
        <div class="title-section">
          ...
          <p class="subtitle">Campañas y automatizaciones de email</p>
        </div>
      </header>
      ...
      <div class="coming-soon">
        ...
        <div class="features-preview">
          ...
          <ul>
            <li>📬 Editor drag & drop de emails</li>
            <li>🎂 Emails de cumpleaños automáticos</li>
            <li>🔄 Re-engagement para clientes inactivos</li>
            <li>🛒 Carrito abandonado (e-commerce)</li>
            <li>📊 Analytics (opens, clicks, conversiones)</li>
