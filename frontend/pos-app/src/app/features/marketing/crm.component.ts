    ...
    <div class="page-container">
      <header class="page-header">
        ...
        <div class="title-section">
          <h1>👥 CRM Clientes</h1>
          <p class="subtitle">Gestión de relaciones con clientes</p>
        </div>
      </header>
      ...
      <div class="coming-soon">
        ...
        <div class="features-preview">
          ...
          <ul>
            <li>📇 Ficha completa de cada cliente</li>
            <li>📊 Valor de vida del cliente (CLV)</li>
            <li>🏷️ Tags y segmentación automática</li>
            <li>📈 Historial de compras y preferencias</li>
            <li>🎯 Scoring de clientes</li>
