    ...
    <div class="page-container">
      <header class="page-header">
        ...
        <div class="title-section">
          ...
          <p class="subtitle">Gestión de reputación y opiniones</p>
        </div>
      </header>
      ...
      <div class="coming-soon">
        ...
        <div class="features-preview">
          ...
          <ul>
            <li>⭐ Sistema de reviews post-compra</li>
            <li>💬 Feedback privado interno</li>
            <li>📊 NPS Score automático</li>
            <li>🔗 Integración con Google Reviews</li>
            <li>📈 Dashboard de reputación</li>
            <li>🚨 Alertas de reviews negativos</li>
          </ul>
        </div>
      </div>
    </div>
