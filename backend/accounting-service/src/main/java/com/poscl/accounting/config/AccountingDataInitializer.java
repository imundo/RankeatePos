...
public class AccountingDataInitializer implements CommandLineRunner {
    ...
    private void initializeChileanChartOfAccounts() {
        ...
        Account activoNoCorriente = createAccount("1200", "Activo No Corriente", Account.AccountType.ASSET, activos, false);
        ...
        Account pasivoCorriente = createAccount("2100", "Pasivo Corriente", Account.AccountType.LIABILITY, pasivos, false);
        ...
        // INGRESOS
        Account ingresos = createRootAccount("4000", "INGRESOS", Account.AccountType.REVENUE);
        createAccount("4100", "Ventas", Account.AccountType.REVENUE, ingresos, true);
        createAccount("4200", "Otros Ingresos", Account.AccountType.REVENUE, ingresos, true);
        createAccount("4300", "Ingresos Financieros", Account.AccountType.REVENUE, ingresos, true);
    ...
    private Account createRootAccount(String code, String name, Account.AccountType type) {
        Account account = Account.builder()
                ...
                .nature(type == Account.AccountType.ASSET || type == Account.AccountType.EXPENSE 
                    ? Account.AccountNature.DEBIT : Account.AccountNature.CREDIT)
                .level(1)
    ...
    private Account createAccount(String code, String name, Account.AccountType type, Account parent, boolean allowsMovements) {
        Account account = Account.builder()
                .tenantId(DEMO_TENANT_ID)
                .code(code)
                .name(name)
