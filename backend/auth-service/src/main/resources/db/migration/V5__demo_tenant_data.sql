...
('c1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001'), -- Carlos en Casa Matriz
('c1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001'), -- María en Casa Matriz
('c1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000001'), -- Juan en Casa Matriz
('c1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000002'), -- Ana en Las Condes
('c1000000-0000-0000-0000-000000000005', 'b1000000-0000-0000-0000-000000000001'); -- Pedro en Casa Matriz

-- Asignación de roles El Trigal
INSERT INTO user_roles (user_id, role_id) VALUES
('c1000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001'), -- Carlos = OWNER_ADMIN
('c1000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002'), -- María = MANAGER
('c1000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000003'), -- Juan = CASHIER
('c1000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000003'), -- Ana = CASHIER
('c1000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000004'); -- Pedro = STOCKKEEPER
...
INSERT INTO user_branches (user_id, branch_id) VALUES
('c2000000-0000-0000-0000-000000000001', 'b2000000-0000-0000-0000-000000000001'), -- Pedro en Local Principal
('c2000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000001'), -- Rosa en Local Principal
('c2000000-0000-0000-0000-000000000003', 'b2000000-0000-0000-0000-000000000001'), -- Diego en Local Principal
('c2000000-0000-0000-0000-000000000004', 'b2000000-0000-0000-0000-000000000002'); -- Camila en Macul

-- Asignación de roles Don Pedro
INSERT INTO user_roles (user_id, role_id) VALUES
('c2000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001'), -- Pedro = OWNER_ADMIN
('c2000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002'), -- Rosa = MANAGER
('c2000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000003'), -- Diego = CASHIER
('c2000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000003'); -- Camila = CASHIER
