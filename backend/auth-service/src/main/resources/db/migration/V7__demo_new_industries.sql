...
('c3000000-0000-0000-0000-000000000002', 'b3000000-0000-0000-0000-000000000002'),
('c3000000-0000-0000-0000-000000000003', 'b3000000-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;

-- Asignación de roles Academia
INSERT INTO user_roles (user_id, role_id) VALUES
('c3000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001'),
('c3000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002'),
('c3000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000003')
ON CONFLICT DO NOTHING;
...
INSERT INTO user_branches (user_id, branch_id) VALUES
('c4000000-0000-0000-0000-000000000001', 'b4000000-0000-0000-0000-000000000001'),
('c4000000-0000-0000-0000-000000000002', 'b4000000-0000-0000-0000-000000000002'),
('c4000000-0000-0000-0000-000000000003', 'b4000000-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;

-- Asignación de roles Editorial
INSERT INTO user_roles (user_id, role_id) VALUES
('c4000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001'),
('c4000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002'),
('c4000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000003')
ON CONFLICT DO NOTHING;
