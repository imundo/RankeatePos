package com.poscl.crm.config;

import com.poscl.crm.domain.entity.*;
import com.poscl.crm.domain.repository.*;
...
public class DataLoader implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                System.out.println("Seeding demo data for crm-service...");
        ...
        private List<Customer> createCustomers(UUID tenantId) {
                return List.of(
                                createCustomer(tenantId, "María González", "maria@email.cl", "+56912345678",
                                                Customer.CustomerSegment.VIP, Customer.LoyaltyTier.PLATINUM, 25000, 15,
                                                450000,
                                                LocalDate.of(1985, 3, 15)),
                                createCustomer(tenantId, "Carlos Rodríguez", "carlos@email.cl", "+56923456789",
                                                Customer.CustomerSegment.VIP, Customer.LoyaltyTier.PLATINUM, 22000, 12,
                                                380000,
                                                LocalDate.of(1978, 7, 22)),
                                createCustomer(tenantId, "Ana López", "ana@email.cl", "+56934567890",
                                ...
                                createCustomer(tenantId, "Pedro Sánchez", "pedro@email.cl", "+56945678901",
                                                Customer.CustomerSegment.REGULAR, Customer.LoyaltyTier.SILVER, 4200, 5,
                                                95000,
                                                LocalDate.of(1982, 5, 30)),
                                createCustomer(tenantId, "Sofía Torres", "sofia@email.cl", "+56956789012",
                                ...
                                createCustomer(tenantId, "Diego Martínez", "diego@email.cl", "+56967890123",
                                                Customer.CustomerSegment.NEW, Customer.LoyaltyTier.BRONZE, 800, 1,
                                                18000,
                                                LocalDate.of(1988, 1, 25)),
                                createCustomer(tenantId, "Valentina Muñoz", "valentina@email.cl", "+56978901234",
                                                Customer.CustomerSegment.AT_RISK, Customer.LoyaltyTier.SILVER, 3000, 4,
                                                72000,
                                                LocalDate.of(1992, 6, 18)),
                                createCustomer(tenantId, "Joaquín Sepúlveda", "joaquin@email.cl", "+56989012345",
                                                Customer.CustomerSegment.REGULAR, Customer.LoyaltyTier.GOLD, 6500, 6,
                                                145000,
        ...
        private List<EmailTemplate> createEmailTemplates(UUID tenantId) {
                return List.of(
                                createTemplate(tenantId, "Bienvenida", "¡Bienvenido/a a nuestra familia, {{name}}!",
                                                EmailTemplate.TemplateType.AUTOMATED,
                                                EmailTemplate.AutomationTrigger.WELCOME),
                                createTemplate(tenantId, "Cumpleaños",
                                                "🎂 ¡Feliz Cumpleaños {{name}}! Tu regalo te espera",
                                                EmailTemplate.TemplateType.AUTOMATED,
                                                EmailTemplate.AutomationTrigger.BIRTHDAY),
                                createTemplate(tenantId, "Te extrañamos",
                                                "{{name}}, te extrañamos 😢 Vuelve con 15% OFF",
                                                EmailTemplate.TemplateType.AUTOMATED,
                                                EmailTemplate.AutomationTrigger.RE_ENGAGEMENT),
                                createTemplate(tenantId, "Promoción Navidad",
                                                "🎄 Ofertas especiales de Navidad para ti",
                                                EmailTemplate.TemplateType.Crm, null),
                                createTemplate(tenantId, "Gracias por tu compra", "¡Gracias por tu compra, {{name}}!",
                                                EmailTemplate.TemplateType.TRANSACTIONAL,
                                                EmailTemplate.AutomationTrigger.POST_PURCHASE));
        }
        ...
        private void createPromotionsWithCoupons(UUID tenantId) {
                // Promo 1: Navidad
                Promotion p1 = createPromotion(tenantId, "10% Descuento Navidad", Promotion.PromotionType.PERCENTAGE,
                                10, 10000,
                                null, null);
                ...
                // Promo 2: VIP
                Promotion p2 = createPromotion(tenantId, "15% VIP Exclusivo", Promotion.PromotionType.PERCENTAGE, 15,
                                20000,
                ...
                // Promo 3: 2x1
                Promotion p3 = createPromotion(tenantId, "2x1 en Postres", Promotion.PromotionType.BOGO, 50, 0, null,
                                null);
                p3 = promotionRepository.save(p3);
                couponRepository.save(createCoupon(p3, "POSTRE2X1", 200, 34));

                // Promo 4: Descuento fijo
                Promotion p4 = createPromotion(tenantId, "$5.000 Descuento", Promotion.PromotionType.FIXED_AMOUNT, 5000,
                                25000,
                                null, null);
        ...
        private Promotion createPromotion(UUID tenantId, String name, Promotion.PromotionType type, double value,
                ...
                p.setMinPurchase(BigDecimal.valueOf(minPurchase));
        ...
        private List<Review> createReviews(UUID tenantId, List<Customer> customers) {
                return List.of(
                                createReview(tenantId, customers.get(0), 5,
                                                "¡Excelente atención y productos de primera calidad!",
                                                Review.ReviewStatus.APPROVED, "¡Gracias María!"),
                                createReview(tenantId, customers.get(1), 5,
                                                "El mejor lugar para reuniones de negocios.",
                                ...
                                createReview(tenantId, customers.get(3), 4,
                                                "Muy buena comida, tiempo de espera un poco largo.",
                                ...
                                createReview(tenantId, customers.get(6), 3,
                                                "La comida estuvo bien, servicio podría mejorar.",
        ...
        private List<Referral> createReferrals(UUID tenantId, List<Customer> customers) {
                return List.of(
                                createReferral(tenantId, customers.get(0), customers.get(4),
                                                Referral.ReferralStatus.REWARDED, 5000,
                                                3000, true, true, 18500),
                                createReferral(tenantId, customers.get(0), customers.get(5),
                                                Referral.ReferralStatus.CONVERTED, 5000,
                                                3000, false, true, 15200),
                                createReferral(tenantId, customers.get(1), customers.get(7),
                                                Referral.ReferralStatus.CONVERTED, 5000,
                                                3000, false, true, 12800),
                                createReferral(tenantId, customers.get(2), null, Referral.ReferralStatus.PENDING, 5000,
                                                3000, false,
                                                false, 0));
        }

        private Referral createReferral(UUID tenantId, Customer referrer, Customer referred,
