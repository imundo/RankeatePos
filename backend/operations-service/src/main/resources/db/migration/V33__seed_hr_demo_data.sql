...
('p1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'El Trigal - Entrada Principal', 'eltrigal-entrada-2026', true, 245, 230),
('p2000000-0000-0000-0000-000000000002', 'a2000000-0000-0000-0000-000000000002', 'Don Pedro - Local Ñuñoa', 'donpedro-nunoa-2026', true, 180, 175),
('p3000000-0000-0000-0000-000000000003', 'a3000000-0000-0000-0000-000000000003', 'Academia - Oficina Central', 'academia-central-2026', true, 320, 315),
('p4000000-0000-0000-0000-000000000004', 'a4000000-0000-0000-0000-000000000004', 'Editorial - Taller', 'editorial-taller-2026', true, 210, 205),
('p5000000-0000-0000-0000-000000000005', 'a5000000-0000-0000-0000-000000000005', 'La Selecta - Local', 'laselecta-entrada-2026', true, 150, 145),
('p6000000-0000-0000-0000-000000000006', '11111111-1111-1111-1111-111111111111', 'El Bigote - Salón', 'elbigote-salon-2026', true, 190, 185),
('p7000000-0000-0000-0000-000000000007', '22222222-2222-2222-2222-222222222222', 'Mente Sana - Clínica', 'mentesana-clinica-2026', true, 280, 275)
ON CONFLICT DO NOTHING;
